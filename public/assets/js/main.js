...
socket.on('join_room_response', (payload) =>{
    ...
    let newString = '<p class=\'join_room_response\'>'+payload.username+' joined the '+payload.room+'. (there are '+payload.count+' users in the room';
...
socket.on('send_chat_message_response', (payload) =>{
    ...
    let newString = '<p class=\'send_chat_message\'><b>'+payload.username+'</b> : '+payload.message+'</p>';
    $('#messages').prepend(newString);
});
